                ...
                <div class="sec1">
                    <form method="post" id="users" class="input-group" enctype="multipart/form-data"  action = "">
                        <label for="empid">Employee Number</label><br> 
                            <input type="text" id="teacher" name="emp_id" placeholder="ID number" value="<?php echo $emp_id;?>" required><br>
                        <label for="empname">Employee Name</label><br>
                            ...
                            <input type="text" id="" name="emp_mname" placeholder="Middle Name (NOTE: Leave it blank if you have NO middle name)" value="<?php echo $emp_mname;?>">
                        ...
                        <br><br>
                        <button type="submit" class="submit-btn" name="add_emp" >Submit</button>
                    </form> 
                </div>
            </div>
        </div>
